...
public final class HourRangeAttributeConverterTest {

    @Test
    public void testNull() {
        final HourRangeAttributeConverter testee = new HourRangeAttributeConverter();
    ...
    public void testRoundTrip() {
        final HourRangeAttributeConverter testee = new HourRangeAttributeConverter();
        final HourRange value = new HourRange("13:00-14:00");
