...
public final class DayOfTheWeekAttributeConverterTest {

    @Test
    public void testNull() {
        final DayOfTheWeekAttributeConverter testee = new DayOfTheWeekAttributeConverter();
    ...
    public void testRoundTrip() {
        final DayOfTheWeekAttributeConverter testee = new DayOfTheWeekAttributeConverter();
        final DayOfTheWeek value = DayOfTheWeek.MON;
