...
public final class WeeklyOpeningHoursAttributeConverter extends ValueObjectStringAttributeConverter<WeeklyOpeningHours> {

    /**
     * Default constructor.
     */
    public WeeklyOpeningHoursAttributeConverter() {
