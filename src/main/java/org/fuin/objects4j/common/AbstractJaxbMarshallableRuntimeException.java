...
/**
 * Base class for runtime exceptions that removes the stack trace and cause
 * while marshalling and unmarshalling using JAX-B.
 */
public abstract class AbstractJaxbMarshallableRuntimeException
        extends RuntimeException implements ExceptionJaxbMarshallable {
