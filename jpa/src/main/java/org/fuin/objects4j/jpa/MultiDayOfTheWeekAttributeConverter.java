...
public final class MultiDayOfTheWeekAttributeConverter extends ValueObjectStringAttributeConverter<MultiDayOfTheWeek> {

    /**
     * Default constructor.
     */
    public MultiDayOfTheWeekAttributeConverter() {
