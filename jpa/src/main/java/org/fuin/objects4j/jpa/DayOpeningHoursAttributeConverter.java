...
public final class DayOpeningHoursAttributeConverter extends ValueObjectStringAttributeConverter<DayOpeningHours> {

    /**
     * Default constructor.
     */
    public DayOpeningHoursAttributeConverter() {
