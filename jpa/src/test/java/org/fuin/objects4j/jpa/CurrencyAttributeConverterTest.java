...
public final class CurrencyAttributeConverterTest {

    @Test
    public void testNull() {
        final CurrencyAttributeConverter testee = new CurrencyAttributeConverter();
    ...
    public void testRoundTrip() {
        final CurrencyAttributeConverter testee = new CurrencyAttributeConverter();
        final Currency value = Currency.getInstance("EUR");
