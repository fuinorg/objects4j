...
import static org.fuin.objects4j.core.DayOfTheWeek.*;
...
// CHECKSTYLE:OFF
public class DayOpeningHoursTest {
    ...
    @Test
    void testOpenAtDayOpeningHours() {
    ...
    @Test
    void testRemoveDayOpeningHours() {
