...
public final class FieldTextInfoTest {
    ...
    public final void testCreateClassLocale() throws Exception {
        ...
        final List<FieldTextInfo> list = new AnnotationAnalyzer()
                .createFieldInfos(MyClass.class, Locale.ENGLISH, Label.class);
        ...
        final FieldTextInfo infoBirthday = new FieldTextInfo(
                MyClass.class.getDeclaredField("birthday"),
        ...
        assertThat(list).contains(infoFirstName, infoLastName, infoBirthday,
                infoPermanent);
        assertEquals(infoFirstName, list.get(list.indexOf(infoFirstName)),
                "infoFirstName");
        assertEquals(infoLastName, list.get(list.indexOf(infoLastName)),
                "infoLastName");
        assertEquals(infoBirthday, list.get(list.indexOf(infoBirthday)),
                "infoBirthday");
        assertEquals(infoPermanent, list.get(list.indexOf(infoPermanent)),
                "infoPermanent");
    ...
    public final void testCreateFieldLocale() throws Exception {
        ...
        final FieldTextInfo testee = new AnnotationAnalyzer().createFieldInfo(
                field, Locale.ENGLISH, Label.class);
        final FieldTextInfo infoBirthday = new FieldTextInfo(field,
                "MyBundle_en birthday");
        assertEquals(infoBirthday, testee, "infoBirthday");
    ...
    public final void testNoValues() throws Exception {
        ...
        final List<FieldTextInfo> list = new AnnotationAnalyzer()
                .createFieldInfos(A.class, Locale.ENGLISH, Label.class);
        final FieldTextInfo infoX = new FieldTextInfo(
                AbstractA.class.getDeclaredField("x"), null);
        final FieldTextInfo infoY = new FieldTextInfo(
                A.class.getDeclaredField("y"), null);
    ...
    public final void testNoValuesWithProperties() throws Exception {
        ...
        final List<FieldTextInfo> list = new AnnotationAnalyzer()
                .createFieldInfos(B.class, Locale.ENGLISH, Label.class);
        final FieldTextInfo infoX = new FieldTextInfo(
                AbstractB.class.getDeclaredField("x"), "AbstractB_en x.Label");
        final FieldTextInfo infoY = new FieldTextInfo(
                B.class.getDeclaredField("y"), "B_en y.Label");

        assertThat(list).isNotNull();
        assertThat(list.size()).isEqualTo(2);
        assertThat(list).contains(infoX, infoY);
        assertThat(list.get(list.indexOf(infoX)).getText()).isEqualTo(
                infoX.getText());
        assertThat(list.get(list.indexOf(infoY)).getText()).isEqualTo(
                infoY.getText());
    ...
    public final void testDefaultValue() throws Exception {
        ...
        final List<FieldTextInfo> list = new AnnotationAnalyzer()
                .createFieldInfos(C.class, Locale.ENGLISH, Label.class);
        final FieldTextInfo info = new FieldTextInfo(
                C.class.getDeclaredField("c"), "Ccc");
        assertThat(list).isNotNull();
    ...
    public final void testDefaultValueWithProperties() throws Exception {
        ...
        final List<FieldTextInfo> list = new AnnotationAnalyzer()
                .createFieldInfos(D.class, Locale.ENGLISH, Label.class);
        final FieldTextInfo info = new FieldTextInfo(
                D.class.getDeclaredField("d2"), "DEFAULT D.d2");
        assertThat(list).isNotNull();
        assertThat(list.size()).isEqualTo(2);
        assertThat(list).contains(info);
        assertThat(list.get(list.indexOf(info)).getText()).isEqualTo(
                info.getText());
    ...
    public final void testDefaultValueAndKey() throws Exception {
        ...
        final List<FieldTextInfo> list = new AnnotationAnalyzer()
                .createFieldInfos(E.class, Locale.ENGLISH, Label.class);
        final FieldTextInfo info = new FieldTextInfo(
                E.class.getDeclaredField("e"), "Eee");
        assertThat(list).isNotNull();
        assertThat(list.size()).isEqualTo(1);
        assertThat(list).contains(info);
        assertEquals(info, list.get(list.indexOf(info)), "info");
    ...
    public final void testDefaultValueAndKeyWithProperties() throws Exception {
        ...
        final List<FieldTextInfo> list = new AnnotationAnalyzer()
                .createFieldInfos(F.class, Locale.ENGLISH, Label.class);
        final FieldTextInfo info = new FieldTextInfo(
                F.class.getDeclaredField("f"), "Fff");
        assertThat(list).isNotNull();
        assertThat(list.size()).isEqualTo(1);
        assertThat(list).contains(info);
        assertEquals(info, list.get(list.indexOf(info)), "info");
    ...
    public final void testShortTextAndKey() throws Exception {
        ...
        final List<FieldTextInfo> list = new AnnotationAnalyzer()
                .createFieldInfos(G.class, Locale.ENGLISH, ShortLabel.class);
        final FieldTextInfo info = new FieldTextInfo(
                G.class.getDeclaredField("g"), "Ggg");
        assertThat(list).isNotNull();
        assertThat(list.size()).isEqualTo(1);
        assertThat(list).contains(info);
        assertEquals(info, list.get(list.indexOf(info)), "info");
    ...
    public final void testShortTextAndKeyWithProperties() throws Exception {
        ...
        final List<FieldTextInfo> list = new AnnotationAnalyzer()
                .createFieldInfos(H.class, Locale.ENGLISH, ShortLabel.class);
        final FieldTextInfo info = new FieldTextInfo(
                H.class.getDeclaredField("h"), "H_en hh_short");
        assertThat(list).isNotNull();
        assertThat(list.size()).isEqualTo(1);
        assertThat(list).contains(info);
        assertEquals(info, list.get(list.indexOf(info)), "info");
    ...
    public final void testShortWithProperties() throws Exception {
        ...
        final List<FieldTextInfo> list = new AnnotationAnalyzer()
                .createFieldInfos(I.class, Locale.ENGLISH, ShortLabel.class);
        final FieldTextInfo info = new FieldTextInfo(
                I.class.getDeclaredField("i"), "I_en i.ShortLabel");
        assertThat(list).isNotNull();
        assertThat(list.size()).isEqualTo(1);
        assertThat(list).contains(info);
        assertEquals(info, list.get(list.indexOf(info)), "info");
    ...
    private void assertEquals(final FieldTextInfo expected,
            final FieldTextInfo actual, final String descr) {
        assertThat(actual.getField()).describedAs(descr).isEqualTo(
                expected.getField());
        assertThat(actual.getText()).describedAs(descr).isEqualTo(
                expected.getText());
        assertThat(actual.getTextOrField())
                .isEqualTo(expected.getTextOrField());
    }
