...
/**
 * Test for the {@link HourRangesConverter} class.
 */
class HourRangesConverterTest {
    ...
    void testUnmarshalErrorJsonb() {
        ...
        assertThatThrownBy(() -> fromJson(invalidJsonData, Data.class, new HourRangesConverter()))
