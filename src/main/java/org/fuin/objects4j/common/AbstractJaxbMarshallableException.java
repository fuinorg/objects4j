...
public abstract class AbstractJaxbMarshallableException extends Exception implements
     ...
     * JAX-B constructor.
     */
    protected AbstractJaxbMarshallableException() {
        super();
    }
     ...
     * 
     * This method will remove the stack trace before the exception is serialized. This avoids having empty
    ...
    /**
     * This method is called after all the properties (except IDREF) are unmarshalled for this object, but
     * before this object is set to the parent object.
     * 
     * @param unmarshaller
     *            Unmarshaller.
     * @param parent
    ...
    private static void setPrivateField(final Object obj, final String name, final Object value) {
        try {
            ...
            throw new RuntimeException(
                    "Failed to set field '" + name + "' in class '" + obj.getClass() + "'", ex);
        }
    }
