 ...
 */
public final class HourRangesStrValidator implements ConstraintValidator<HourRangesStr, String> {
    ...
    /**
     * Check that a given string is a valid {@link org.fuin.objects4j.core.HourRanges}.
     * 
     * @param value
     *            Value to check.
     * 
