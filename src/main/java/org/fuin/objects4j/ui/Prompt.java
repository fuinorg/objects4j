...
/**
 * Use this annotation to assign a prompt to a type of object or an object's attribute. The prompt may be used by UI elements to display an
...
public @interface Prompt {
    ...
    /**
     * Default prompt text. This is only used if no entry in the resource bundle can be found.
     * 
     * @return Value.
     */
